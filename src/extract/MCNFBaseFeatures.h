...
class BaseFeatures1 : public IExtractor {
    ...
    std::array<unsigned, N_OBJ_ANALYZED> n_soft_clauses;
    std::array<uint64_t, N_OBJ_ANALYZED> weight_sum;
    ...
    std::array<std::array<unsigned, 11>, N_OBJ_ANALYZED> soft_clause_sizes;
    ...
    // Soft clause weights
    std::array<std::vector<uint64_t>, N_OBJ_ANALYZED> weights;
